...
module.exports = class x extends u {
  ...
  async ["execute"]() {
    ...
    try {
      ...
      this.client.consoleManager.log('[API 1] | [Update Module] Running the verification process', 7);
        ...
        for (const guildDataAPI of guildsData) {
          ...
          function isEqual(db, api) {
            return db.cached === api.cached &&
              ...
              db.constellation === api.constellation.name &&
              db.joinedAt === api.constellation.joinedAt &&
          ...
          if (!existingGuildData) {
            ...
            await GuildData.findOneAndUpdate(
              ...
              this.client.consoleManager.log(`[API 1] | [Update Module] An error has occurred while trying to update the guild ${guildDataAPI.id}: ${err}`, 5);
            });
            ...
            await this.downloadImage(guildDataAPI.icon, iconPath);
            await this.downloadImage(guildDataAPI.banner, bannerPath);
            ...
            this.client.consoleManager.log(`[API 1] | [Update Module] The guild ${guildDataAPI.id} has been successfully updated on the database`, 0);
          }
        }
      }
      this.client.consoleManager.log('[API 1] | [Update Module] Stopping the verification process', 7)
    } catch (e) {
